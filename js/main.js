                ...
                (r = void 0 === r || r),
                    ...
                    null != t.modifiersData.popperOffsets &&
                        (t.styles.popper = Object.assign(
                            ...
                            W(Object.assign(Object.assign({}, e), {}, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: r, roundOffsets: n }))
                        )),
                    null != t.modifiersData.arrow &&
                        (t.styles.arrow = Object.assign(Object.assign({}, t.styles.arrow), W(Object.assign(Object.assign({}, e), {}, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: n })))),
...
!(function (t, e) {
    ...
    function M(t, e) {
        var n = Object.assign(
            ...
            e.ignoreAttributes
                ? {}
                : (function (t, e) {
                      return (e ? Object.keys(R(Object.assign({}, D, { plugins: e }))) : k).reduce(function (e, n) {
    ...
    function S(t) {
        ...
        function i(n, r) {
            ...
            r.theme ? o.setAttribute("data-theme", r.theme) : o.removeAttribute("data-theme"),
                ...
                r.arrow ? (s ? n.arrow !== r.arrow && (o.removeChild(s), o.appendChild(V(r.arrow))) : o.appendChild(V(r.arrow))) : s && o.removeChild(s);
        }
        return (r.className = "tippy-content"), r.setAttribute("data-state", "hidden"), j(r, t.props), e.appendChild(n), n.appendChild(r), i(t.props, t.props), { popper: e, onUpdate: i };
    }
    S.$$tippy = !0;
    var B = 1,
        H = [],
    ...
    function U(e, n) {
        var a,
            ...
            W = {
                ...
                setProps: function (t) {
                    ...
                    var n = W.props,
                        r = M(e, Object.assign({}, W.props, {}, t, { ignoreAttributes: !0 }));
        ...
        function vt(t, n, r) {
            void 0 === r && (r = !1),
                p(W.props.triggerTarget || e).forEach(function (e) {
                    e.addEventListener(t, n, r), U.push({ node: e, eventType: t, handler: n, options: r });
                });
        }
        function mt() {
            var t;
            K() && (vt("touchstart", ht, { passive: !0 }), vt("touchend", yt, { passive: !0 })),
                ...
                ((function (t, e) {
                    ...
                    Ct()
                        ...
                        .map(function (t) {
                            ...
                            return n ? { popperRect: t.getBoundingClientRect(), popperState: n, props: k } : null;
                        })
                        .filter(Boolean),
                    t
                ) &&
        ...
        function Et() {
            ...
            var n = W.props,
                ...
                s = n.moveTransition,
                u = Q() ? I(Y).arrow : null,
                c = a ? { getBoundingClientRect: a, contextElement: a.contextElement || Z() } : e,
                p = [
            ...
            Q() && u && p.push({ name: "arrow", options: { element: u, padding: 3 } }),
                p.push.apply(p, (null == r ? void 0 : r.modifiers) || []),
                (W.popperInstance = t.createPopper(c, Y, Object.assign({}, r, { placement: i, onFirstUpdate: A, modifiers: p })));
        }
        function Tt() {
    ...
    var F = {
        ...
        fn: function (t) {
            ...
            return {
                onCreate: function () {
                    o && (r.insertBefore(o, r.firstElementChild), r.setAttribute("data-animatefill", ""), (r.style.overflow = "hidden"), t.setProps({ arrow: !1, animation: "shift-away" }));
                },
                onMount: function () {
                    if (o) {
        ...
        fn: function (t) {
            ...
            return {
                ...
                onTrigger: function (t, e) {
                    g(e) && (W = { clientX: e.clientX, clientY: e.clientY }), (i = "focus" === e.type);
                },
                onHidden: function () {
    ...
    return (
        ...
        (_.createSingleton = function (t, e) {
            ...
            var f = {
                ...
                l = _(v(), Object.assign({}, c(e, ["overrides"]), { plugins: [f].concat(e.plugins || []), triggerTarget: i })),
                d = l.setProps;
            return (
        ...
        (_.delegate = function (t, e) {
            ...
            function d(t, e, r, i) {
                void 0 === i && (i = !1), t.addEventListener(e, r, i), n.push({ node: t, eventType: e, handler: r, options: i });
            }
            return (
